package com.example.tflite_yolov5_test_V1.compass;
...
public class SOTWFormatter {
    ...
    private void initLocalizedNames(Context context) {
        ...
        if (names == null) {
            names = new String[]{
                    context.getString(com.example.tflite_yolov5_test_V1.R.string.sotw_north),
                    context.getString(com.example.tflite_yolov5_test_V1.R.string.sotw_eastnorth),
                    context.getString(com.example.tflite_yolov5_test_V1.R.string.sotw_east),
                    context.getString(com.example.tflite_yolov5_test_V1.R.string.sotw_eastsouth),
                    context.getString(com.example.tflite_yolov5_test_V1.R.string.sotw_south),
                    context.getString(com.example.tflite_yolov5_test_V1.R.string.sotw_westsouth),
                    context.getString(com.example.tflite_yolov5_test_V1.R.string.sotw_west),
                    context.getString(com.example.tflite_yolov5_test_V1.R.string.sotw_westnorth),
                    context.getString(com.example.tflite_yolov5_test_V1.R.string.sotw_north)
            };
        }
    }
